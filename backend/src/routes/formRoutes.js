...
import { createForm, updateForm, getMyForms, getFormById, submitResponse, getFormResponses, deleteForm, checkSlugAvailability } from '../handlers/formHandler.js';
...
router.get('/check-slug', verifyToken, checkSlugAvailability); // Check Slug
